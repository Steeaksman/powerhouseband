<template>
 ...
 <img class="transform hover:scale-125 hover:rounded-xl duration-200" /src="images/girlsinger.jpg" alt="bandlogo"/>
 <img class="transform hover:scale-125 hover:rounded-xl duration-200" src="/images/4 members.jpg" alt="bandlogo"/>
 <img  class="transform hover:scale-125 hover:rounded-xl duration-200"src="/images/guitar player.jpg" alt="bandlogo"/>
 <img class="transform hover:scale-125 hover:rounded-xl duration-200" src="/images/drummer.jpg" alt="bandlogo"/>
    </div> -->
